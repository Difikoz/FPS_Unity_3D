...
{
    [CreateAssetMenu(fileName = "Armor", menuName = "Winter Universe/Pawn/Inventory/Item/New Armor")]
    public class ArmorItemConfig : ItemConfig
    {
        ...
        {
            //GameManager.StaticInstance.ControllersManager.Player.Equipment.EquipArmor(this, fromInventory);
        }
    }
}